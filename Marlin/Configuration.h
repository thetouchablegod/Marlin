...
#define STRING_CONFIG_H_AUTHOR "(Thetouchablegod, Ender-3 Pro SKR 1.4T)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TTG's E3 PRO"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -0.5 }
